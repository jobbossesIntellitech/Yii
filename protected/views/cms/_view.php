<h1 class="cms-title"><?php echo Category::breadcrumbpage($view->con_categoryid,false).$view->content_lang->lng_title; ?></h1>
<div class="cms-text"><?php echo JShortCode::filter($view->content_lang->lng_text); ?></div>
<?php
