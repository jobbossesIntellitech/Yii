...
<div class="list-page">
	...
	<ul class="sorting-box" id="not-active">
		<li><a href="<?php echo Jii::app()->createUrl('search/index',array('subsubsubcategory'=>Jii::param('subsubsubcategory'),'subsubcategory'=>Jii::param('subsubcategory'),'subcategory'=>Jii::param('subcategory'),'category'=>Jii::param('category'),'city'=>Jii::param('city'),'country'=>Jii::param('country'),'reference'=>Jii::param('reference'),'keywords'=>Jii::param('keywords'),'field'=>Jii::param('field'),'sort'=>'ads_price','order'=>'ASC'));?>" id="price_low_to_high">Price -- lowest to highest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('search/index',array('subsubsubcategory'=>Jii::param('subsubsubcategory'),'subsubcategory'=>Jii::param('subsubcategory'),'subcategory'=>Jii::param('subcategory'),'category'=>Jii::param('category'),'city'=>Jii::param('city'),'country'=>Jii::param('country'),'reference'=>Jii::param('reference'),'keywords'=>Jii::param('keywords'),'field'=>Jii::param('field'),'sort'=>'ads_price','order'=>'DESC'));?>" id="price_high_to_low">Price -- highest to lowest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('search/index',array('subsubsubcategory'=>Jii::param('subsubsubcategory'),'subsubcategory'=>Jii::param('subsubcategory'),'subcategory'=>Jii::param('subcategory'),'category'=>Jii::param('category'),'city'=>Jii::param('city'),'country'=>Jii::param('country'),'reference'=>Jii::param('reference'),'keywords'=>Jii::param('keywords'),'field'=>Jii::param('field'),'sort'=>'ads_id','order'=>'ASC'));?>" id="date_old_to_new">Date posted -- oldest to newest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('search/index',array('subsubsubcategory'=>Jii::param('subsubsubcategory'),'subsubcategory'=>Jii::param('subsubcategory'),'subcategory'=>Jii::param('subcategory'),'category'=>Jii::param('category'),'city'=>Jii::param('city'),'country'=>Jii::param('country'),'reference'=>Jii::param('reference'),'keywords'=>Jii::param('keywords'),'field'=>Jii::param('field'),'sort'=>'ads_id','order'=>'DESC'));?>" id="date_new_to_old">Date posted -- newest to oldest</a></li>
	</ul>
	<div class="clear"></div>
	...
	if(isset($listads) && !empty($listads) && is_array($listads)){
		foreach($listads as $l){
			$breadcrumb = Item::breadcrumbitem($l->ads_itemid);
		?>
			<div class="item" data-price="<?php echo isset($l->ads_price)?$l->ads_price:'';?>" data-date="<?php echo isset($l->dates->dat_creation)?strtotime($l->dates->dat_creation):'';?>">
				...
				<div class="title">
					<a class="name titillium" href="<?php echo Jii::app()->createUrl('item/preview',Ads::completeUrlOptions($breadcrumb,Ads::urlOptions($l->ads_id,$l->ads_itemid,$l->ads_name)));?>">
						<?php echo $l->ads_name; ?>
					</a>
					<div class="clear"></div>
		...
		echo "<div class='empty-list'>0 results</div>";
	}
	?>
	</div>
...
$('document').ready(function() {	
	...
	$('#number_ads_page #number_of_ads option').parent().change(function(){
		window.location.href = '<?php echo Jii::app()->createUrl('search/index',array('subsubsubcategory'=>Jii::param('subsubsubcategory'),'subsubcategory'=>Jii::param('subsubcategory'),'subcategory'=>Jii::param('subcategory'),'category'=>Jii::param('category'),'city'=>Jii::param('city'),'country'=>Jii::param('country'),'reference'=>Jii::param('reference'),'keywords'=>Jii::param('keywords'),'field'=>Jii::param('field'),'sort'=>Jii::param('sort'),'order'=>Jii::param('order')));?>&number_ads='+$(this).val();
		//alert($(this).val());
	});
});
