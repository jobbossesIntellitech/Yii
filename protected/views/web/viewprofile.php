...
<div class="list-page">
	<div class="list-subcategories">
		<div class="title-box" style="border:none;">
			<span class="titillium" style="font-size:20px;"><?php echo Jii::t("View Member's Profile"); ?></span> 
		</div>
		<div class="clear"></div>
	</div>
</div>
<div class="member-page">
	...
	<div class="member-name">
		<div class="listed-title"><?php echo Jii::t('Full name: ');?></div>
	...
	<div class="member-location">
		<?php echo 'Location: '.Location::breadcrumblocation($user->mbr_locationid,true,$user->mbr_address);?>
	</div>
</div>
...
<div class="list-page">
	...
	<ul class="sorting-box" id="not-active">
		<li><a href="<?php echo Jii::app()->createUrl('web/viewprofile',array('id'=>$user->mbr_id,'sort'=>'ads_price','order'=>'ASC'));?>" id="price_low_to_high">Price -- lowest to highest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('web/viewprofile',array('id'=>$user->mbr_id,'sort'=>'ads_price','order'=>'DESC'));?>" id="price_high_to_low">Price -- highest to lowest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('web/viewprofile',array('id'=>$user->mbr_id,'sort'=>'ads_id','order'=>'ASC'));?>" id="date_old_to_new">Date posted -- oldest to newest</a></li>
		<li><a href="<?php echo Jii::app()->createUrl('web/viewprofile',array('id'=>$user->mbr_id,'sort'=>'ads_id','order'=>'DESC'));?>" id="date_new_to_old">Date posted -- newest to oldest</a></li>
	</ul>
	<div class="clear"></div>
...
$('document').ready(function() {	
	...
	$('#number_ads_page #number_of_ads option').parent().change(function(){
		window.location.href = '<?php echo Jii::app()->createUrl('web/viewprofile',array('id'=>$user->mbr_id,'sort'=>Jii::param('sort'),'order'=>Jii::param('order')));?>&number_ads='+$(this).val();
		//alert($(this).val());
	});
