<?php
class LoggedinShortCode extends JShortCode{
	public function documentation(){
		...
		self::$documentation[$this->getName()]['description'] = 'Writing certain content appears only when the visitor has logged';	
	}
