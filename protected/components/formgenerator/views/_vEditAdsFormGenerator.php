			...
			foreach($form['sections'] AS $k=>$section){
				...
				<fieldset>
					...
					<tr>
						...
						<td><textarea id="description" name="description" class="validate required">'.$description.'</textarea><div class="error-message error">This Field is required!!</div></td>
					</tr>
					<tr>
		...
		$('.form-generator #city').change(function(){
			if($(this).val() != ''){
				ajaxSearch('getCities',{country:$(this).val()},function(data){
					...
					for(var i in data.list){
						area.append('<option value="'+i+'">'+data.list[i]+'</option>');
					}
